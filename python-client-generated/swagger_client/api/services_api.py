...
class ServicesApi(object):
    ...
    def services_read_all(self, **kwargs):  # noqa: E501
        """Read the entire services list  # noqa: E501

        Read the services list  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.services_read_all(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int length: Number of services to get from services
        :param int offset: Offset from beginning of list where to start gathering services
        :return: list[Service]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.services_read_all_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.services_read_all_with_http_info(**kwargs)  # noqa: E501
            return data

    def services_read_all_with_http_info(self, **kwargs):  # noqa: E501
        """Read the entire services list  # noqa: E501

        Read the services list  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.services_read_all_with_http_info(async_req=True)
        >>> result = thread.get()
